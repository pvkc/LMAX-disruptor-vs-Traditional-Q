...
public final class BufferedLinkedBlockingQueue implements Serializable
{
	...
	// Hard-coded Recources.cpu
	// Used in put, putNow.
	private ConcurrentHashMap<Thread, ArrayAndIndex> threadLocal = new ConcurrentHashMap<Thread, ArrayAndIndex>(64 * 2, 0.75f, 64 * 2);
	
	// Used in peek, refreshed after changes made to q. (Inside take function)
	private ConcurrentHashMap<Thread, ArrayAndIndex> receives = new ConcurrentHashMap<Thread, ArrayAndIndex>(64 * 2, 0.75f, 64 * 2);
